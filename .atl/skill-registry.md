...
| `comfyui` | — | user | `/root/.pi/agent/skills/comfyui/SKILL.md` |
...
| `github-pr` | Create high-quality Pull Requests with conventional commits and proper descriptions. Trigger: When creating PRs, writing PR descriptions, or using gh CLI for pull requests. | user | `/root/.claude/skills/gentleman-github-pr/SKILL.md` |
...
| `pytest` | Pytest testing patterns for Python. Trigger: When writing Python tests - fixtures, mocking, markers. | user | `/root/.claude/skills/gentleman-pytest/SKILL.md` |
